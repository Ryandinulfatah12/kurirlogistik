									...
									<div class="card-box">
										<div class="text-xs-center">
												...
												<tbody>
													...
													<h3 class="classic-title"><span><strong><i class="fa fa-truck icon text-default-lter"></i>&nbsp;&nbsp;UPDATE Pengiriman</strong></h3>																					
													<!-- START Checkout form -->										
														...
														<table border="0" align="center" width="100%" >
																<div class="row">
																	...
																	<fieldset class="col-md-6">
																		<legend><strong>Data pengirim:</strong></legend>	
																		<!-- Name -->
																		<div class="row" >
																		...
																		<div class="row">
																			<div class="col-sm-3 form-group">
																				<label class="control-label"><i class="fa fa-database icon text-default-lter"></i>&nbsp;<strong>Pembayaran</strong></label>
