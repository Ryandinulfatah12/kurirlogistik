...
<section class="footer">
    ...
    <div class="footer-block col-md-3 col-sm-3 sm">
        ...
        <ul class="hidden-xs">
            <li><a href="about-us.php" tabindex="-1">Tentang Kami</a></li>
            <li><a href="contact-us.php" tabindex="-1">Hubungi Kami</a></li>
    ...
    <div class="footer-block col-md-3 col-sm-3">
        ...
        <ul class="hidden-xs">
            ...
            <li><a href="login.php" tabindex="-1">Akun Saya</a></li>
...
<div class="fw footer-dark">
    <section class="footer footer-baseline">
        <p class="footer-text mob-me">&copy; Copyright robialakbar Kuris & Logistik</p>
